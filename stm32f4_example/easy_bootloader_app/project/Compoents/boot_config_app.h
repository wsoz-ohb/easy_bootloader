...
#define BOOT_APP_OUT_FLASH_FLAG_OFFSET    0x0CU
...
#define BOOT_APP_OUT_FLASH_FLAG_ADDR      (BOOT_APP_FLAG_REGION_ADDR + BOOT_APP_OUT_FLASH_FLAG_OFFSET)

/* 外部Flash数据标志 */
#define OUT_FLASH_FLAG_READY              1U
#define OUT_FLASH_FLAG_EMPTY              2U
